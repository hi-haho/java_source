...
이러한 상황을 예방하기 위해 미리 일정 갯수의 Connection 객체를 만들어 Pool에 저장을 하고,
사용자의 요청이 발생하면 Connection을 제공하고 사용자와의 연결이 종료된다면 Pool에 다시 반환하여 보관하는 것을 의미합니다.
<hr>
<a href="jsp17ins.html"> 상품 추가 </a> &nbsp;
<a href="javascript:funcUp()"> 상품 수정 </a> &nbsp;
<a href="javascript:funcDel()"> 상품 삭제 </a>
<br><br>
<table border="1">
	<tr>
	...
	<%
	ArrayList<SangpumDTO> list = connP.getdataAll();
	//out.print(list.size());
