...
public class MyLambda4Event {
	...
	public static void main(String[] args) {
		...
		JButton button1 = new JButton("click1"); //이벤트처리
		JButton button2 = new JButton("click2"); //이벤트처리
	...
	static void callMethod() {
		...
		jikwons.add(new Jikwon(1, "나길동"));
		jikwons.add(new Jikwon(2, "고길동"));
