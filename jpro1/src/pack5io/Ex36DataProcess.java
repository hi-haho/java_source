...
public class Ex36DataProcess {
	public static void main(String[] args) throws Exception {
		...
		Ex36BinarayData binarayData = new Ex36BinarayData();
...
//		File f = new File("c:/work/iotest3.dat");
		...
		BufferedOutputStream bo = new BufferedOutputStream(fo,1024); // 1kb로 저장해라
		ObjectOutputStream oo = new ObjectOutputStream(bo);
		oo.writeObject(binarayData);
		...
		Ex36BinarayData data = (Ex36BinarayData)obj;
