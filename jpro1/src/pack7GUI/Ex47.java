...
public class Ex47 extends JFrame implements ActionListener {
	...
	public Ex47() {
		...
		super.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//윈도우 종료 코드
	}
	...
	private void layoutInit() {
		...
		txtName.requestFocus(); // 해당 객체로 커서 이동
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int nai=0;
		try {
			nai = Integer.parseInt(txtAge.getText());//Integer.parseInt방법은 value보다 메모리 덜 잡아먹음
		} catch (Exception e2) {
...
//		System.out.println(rdoM.isSelected()+" "+ rdoF.isSelected());
		...
		String message = "결과: "+txtName.getText()
		+"님의 나이는 : "+ nai + "  성별은 "+ gender+"입니다.";
